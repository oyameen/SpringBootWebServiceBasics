package com.oyameen.SpringBootWebServiceBasics.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    @Bean(name = "employeesManagementWsdl")
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema employeesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://oyameen.com/ws/employee-web-service");
